...
namespace ThunderRipperShared.Files
{
    public class SerializedFile : IDisposable
    {
        ...
        public SerializedFile(Stream stream, IWorkerManager manager)
        {
            ...
            worker = manager.GetWorker(new UnityVersion(TypeTree.UnityVersion));
        }
        ...
        public AssetBase ReadAsset(long index)
        {
            ...
            var assetType = worker.GetTypeForAssetType(info.TypeID);
